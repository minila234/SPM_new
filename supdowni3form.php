...
<?php
    ...
    where Company='abc' AND verfication=1 AND sf.FormI_3 is not null and (sp.FormI_3 is null or sp.FormI_3='')");
?>
<html lang="en">
<head>
		...
		<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto text-center mr-lg-5">
                    ...
                    <li class="nav-item mr-lg-2 mb-lg-0 mb-2">
						<a class="nav-link" href="supdowni1form.php">Fill Form I-1</a>
					</li>
					<li class="nav-item mr-lg-2 mb-lg-0 mb-2 active">
						<a class="nav-link" href="supdowni3form.php">Attest I-3 Forms
